 ...
 * 卷闸门效果
 */
public class DragDoorView1 extends RelativeLayout {
  ...
  public DragDoorView1(Context context) {
    this(context, null);
  }

  public DragDoorView1(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public DragDoorView1(Context context, AttributeSet attrs, int defStyleAttr) {
