...
@SuppressLint({ "DefaultLocale", "SimpleDateFormat" }) public final class Ln {
  ...
  public static int d(Throwable t) {
    return CONFIG.minimumLogLevel <= Log.DEBUG ? print.println(Log.DEBUG, getStackTraceString(t))
        : 0;
  }
  ...
  public static int i(Throwable t) {
    return CONFIG.minimumLogLevel <= Log.INFO ? print.println(Log.INFO, getStackTraceString(t)) : 0;
  }
  ...
  public static int w(Throwable t) {
    return CONFIG.minimumLogLevel <= Log.WARN ? print.println(Log.WARN, getStackTraceString(t)) : 0;
  }
  ...
  public static int e(Throwable t) {
    return CONFIG.minimumLogLevel <= Log.ERROR ? print.println(Log.ERROR, getStackTraceString(t))
        : 0;
  }
